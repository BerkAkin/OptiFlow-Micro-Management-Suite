export const BasicPlan = [
    ...
    { isAvailable: false, text: "Permission Tracking and Approval System" },
...
export const GeneralPlan = [
    ...
    { isAvailable: true, text: "Permission Tracking and Approval System" },
    { isAvailable: false, text: "Employee Support" },
    { isAvailable: false, text: "Appreciation System" },
]
export const FullPlan = [
    ...
    { isAvailable: true, text: "Corporate Suggestion and Innovation" },
    { isAvailable: true, text: "Permission Tracking and Approval System" },
    { isAvailable: true, text: "Employee Support" },
    { isAvailable: true, text: "Appreciation System" },
]
