                ...
                {({ isSubmitting, setFieldValue, values }) => (
                    <Form className="p-4 space-y-1">
                        ...
                        <div className="flex justify-center pt-2">
                            <button type="submit" className={`${colorScheme} ${hoverScheme} transition-transform duration-150 active:scale-[0.98]  cursor-pointer text-white w-full py-2 flex items-center  justify-center rounded-sm transition`} >
                                <img src={send} alt="" width={25} />
                            </button>
                            {onCancel &&
                                <button type='button' onClick={onCancel} className={`transition-transform duration-150 active:scale-[0.98] bg-red-400 hover:bg-red-500 cursor-pointer text-white w-[50px] py-2 mx-2 flex items-center  justify-center rounded-sm transition`} >
