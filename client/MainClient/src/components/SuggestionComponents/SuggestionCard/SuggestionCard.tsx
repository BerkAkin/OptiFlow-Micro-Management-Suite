...
function SuggestionCard({ Status, Header, Description, VoteCount, CommentCount, Comments }: SuggestionCardProps) {
    ...
    return (
        <div className='border rounded-lg m-6 relative'>
            ...
            <div className='p-6 text-center flex justify-center items-center h-[25%] w-full grid grid-cols-3'>
                <div className='justify-center flex'>
                    <button className='bg-red-500 rounded-full shadow-custom  w-6 text-white'>✘</button>
                    <button className='bg-green-500 rounded-full shadow-custom  w-6 text-white mx-1 '>✔</button>
                </div>
                <div>
                    <p className='text-gray-800'><span><button className='text-2xl'>⇩</button></span> {VoteCount} <span><button className='text-2xl'>⇧</button></span></p>
                </div>
                <div>
