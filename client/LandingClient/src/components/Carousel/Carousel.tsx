            ...
            <div className='relative flex items-center justify-center text-gray-700'>
                {carouselItems.map((item, index) => (
                    <motion.div
                        ...
                        className={`grid grid-cols-2 absolute shadow-md cursor-pointer rounded-lg w-[700px] h-[400px] border border-gray-200`}
                    ...
                    >
                        ...
                        <div>
                            <div className='bg-white h-[280px] rounded-b-lg border border-gray-100'>
                                <h2 className="font-rubik font-bold text-center p-5 text-xl">{item.title}</h2>
